...
But why malware author use inline assembly? Maybe because inline assembly allows direct access to the fs segment register, which is not possible with standard C code.
